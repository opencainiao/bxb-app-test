...
public class ClientUpdateBase {
	...
	private static Client makeClient() {
		...
		client.setBirth_ages("5");
		client.setBlood_group("5");
		client.setBoy_num(5);
		client.setAge_group("A");
		client.setAnnual_income_family(36.30);
		client.setAnnual_income_family_type("5");
		client.setAnnual_income_personal(25);
		client.setAnnual_income_personal_type("5");
		client.setCareer_type("5");
		client.setClient_name("测试修改用户_________");
		client.setCompany("中国农业银行xxxx");
		client.setCompany_nature("5");
		client.setConstellation("32");
		client.setContact_attention("mmmmmmmmmmmmm");
		client.setContact_type("A");
		client.setEducation_type("5");
		client.setFamily_financial_standing("A");
		client.setFamily_income_feature("5");
		client.setGirl_num(5);
		client.setIntroducer_closeness("5");
		client.setIntroducer_evaluation("mmmmmmmmmmmmm");
		client.setIntroducer_name("mmmmmmmmmmmmm");
		client.setIntroducer_relationship("5");
		client.setJob_level("5");
		client.setJob_position("5");
		client.setMarital_status("5");
		client.setOwner_user_id(userid);
		client.setPdp_type("5");
		client.setRegion_code("3_33");
		client.setRegion_type("5");
		client.setRegion_name("wfwfwfwfwfwf");
		client.setSex("5");
		client.setSource_type("5");
		client.setTrade_type("5");
	...
	public static void main(String[] args) {
		...
		// String url =
		// "http://localhost:8080/bxb/app/client/55b85c67caf87373e36f7844/delete";
		// post(url);
